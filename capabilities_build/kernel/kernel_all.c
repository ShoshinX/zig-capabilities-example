#line 1 "/host/sel4-tutorials-manifest/kernel/src/api/faults.c"
/*
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/api/syscall.c"
/*
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/c_traps.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/kernel/elf.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/kernel/thread.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/kernel/vspace.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_KERNEL_LOG_BUFFER */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/machine/capdl.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_DEBUG_BUILD */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/machine/registerset.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/model/smp.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ENABLE_SMP_SUPPORT */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/model/statedata.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/object/objecttype.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/64/smp/ipi.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ENABLE_SMP_SUPPORT */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/api/faults.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/benchmark/benchmark.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/c_traps.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/idle.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/apic.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/boot.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/boot_sys.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/cmdline.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/ept.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_VTX */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/smp_sys.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ENABLE_SMP_SUPPORT */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/thread.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/vspace.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/x2apic.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_X2APIC */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/kernel/xapic.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_XAPIC */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/machine/breakpoint.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/machine/capdl.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/machine/cpu_identification.c"
/*
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/machine/fpu.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/machine/hardware.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/machine/registerset.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/model/statedata.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/object/interrupt.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/object/ioport.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/object/iospace.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_IOMMU */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/object/objecttype.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/object/tcb.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ENABLE_SMP_SUPPORT */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/object/vcpu.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/arch/x86/smp/ipi.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ENABLE_SMP_SUPPORT */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/assert.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/benchmark/benchmark_track.c"
/*
 * Copyright 2016, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/benchmark/benchmark_utilisation.c"
/*
 * Copyright 2016, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_BENCHMARK_TRACK_UTILISATION */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/fastpath/fastpath.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/inlines.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/kernel/boot.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/kernel/cspace.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/kernel/faulthandler.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/kernel/stack.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/kernel/thread.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/machine/capdl.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_DEBUG_BUILD */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/machine/fpu.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/machine/io.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_PRINTING */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/machine/registerset.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/model/preemption.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/model/smp.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ENABLE_SMP_SUPPORT */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/model/statedata.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_KERNEL_LOG_BUFFER */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/object/cnode.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/object/endpoint.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/object/interrupt.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/object/notification.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/object/objecttype.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/object/tcb.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/object/untyped.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/plat/pc99/machine/acpi.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/plat/pc99/machine/hardware.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/plat/pc99/machine/intel-vtd.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_IOMMU */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/plat/pc99/machine/io.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* CONFIG_DEBUG_BUILD */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/plat/pc99/machine/ioapic.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/plat/pc99/machine/pic.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/plat/pc99/machine/pit.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/smp/ipi.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ENABLE_SMP_SUPPORT */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/smp/lock.c"
/*
 * Copyright 2020, Data61, CSIRO (ABN 41 687 119 230)
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif /* ENABLE_SMP_SUPPORT */
#line 1 "/host/sel4-tutorials-manifest/kernel/src/string.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#line 1 "/host/sel4-tutorials-manifest/kernel/src/util.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
...
#endif
#line 1 "/host/sel4-tutorials-manifest/kernel/src/config/default_domain.c"
/*
 * Copyright 2014, General Dynamics C4 Systems
 *
 * SPDX-License-Identifier: GPL-2.0-only
